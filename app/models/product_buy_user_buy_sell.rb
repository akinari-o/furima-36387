class ProductBuyUserBuySell
  ...
  def save
   ...
   user_buy_sell = UserBuySell.create(user_id: user_id, item_id: item_id)
    ...
    ProductBuy.create(postal_code: postal_code, prefecture_id: prefecture_id, municipalities: municipalities, address: address, building_name: building_name, telephone_number:telephone_number,user_buy_sell_id: user_buy_sell.id)
